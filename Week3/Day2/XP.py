...
all_cats = [Bengal('Bengal Cat', 3), Chartreux(
    'Chartreux Cat', 7), Siamese('Siamese Cat', 5)]
...
# called other_dog. This method returns a string stating
# which dog won the fight. The winner should be the dog
# with the higher run_speed x weight.
